...
const tiers = [
  {
    ...
    name: "Free Quote",
    price: "$0",
    desc: "No-obligation estimate",
    features: ["In-home consultation", "Detailed estimate", "Material recs", "Timeline planning", "No pressure"],
    cta: "Text for Quote",
    link: "sms:2109809174",
    popular: false,
    bg: "bg-gray-100"
  },
  {
    ...
    price: "$4,500",
    note: "Starting at",
    desc: "Transform your bathroom",
    features: ["Tile and flooring", "Vanity and fixtures", "Shower upgrades", "Lighting", "Full management"],
    cta: "Get Started",
    link: STRIPE_URL,
    popular: false,
    bg: "bg-sky-50"
  },
  {
    ...
    price: "$9,500",
    note: "Starting at",
    desc: "Heart of your home",
    features: ["Cabinet installation", "Countertops", "Flooring", "Appliance hookups", "Full transform"],
    cta: "Get Started",
    link: STRIPE_URL,
    popular: true,
    bg: "bg-amber-50"
  },
  {
    ...
    features: ["Multi-room remodels", "Structural changes", "Outdoor spaces", "Custom carpentry", "End-to-end"],
    cta: "Schedule Call",
    link: CALENDLY_URL,
    popular: false,
    bg: "bg-teal-50"
  },
  {
    ...
    features: ["Churches", "Commercial", "New construction", "Flexible payments", "Any budget"],
    cta: "Lets Talk",
    link: "sms:2109809174",
    popular: false,
    bg: "bg-gray-100"
    ...
    <section id="pricing" data-testid="pricing-section" className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="font-serif text-4xl font-bold text-teal-900 mb-6">
            Simple Pricing. <span className="text-amber-500">Exceptional Value.</span>
          </h2>
          ...
          {tiers.map(function(tier) {
            return (
              <div
                ...
                className={"relative rounded-2xl p-5 " + tier.bg + " border-2 " + (tier.popular ? "border-amber-500 shadow-lg" : "border-transparent hover:border-teal-200")}
              >
                {tier.popular && (
                ...
                <a
                  ...
                  className={"block w-full text-center py-2.5 rounded-lg font-bold text-sm " + (tier.popular ? "bg-amber-500 text-white hover:bg-amber-600" : "bg-teal-900 text-white hover:bg-teal-800")}
                >
                  {tier.cta}
                </a>
              </div>
